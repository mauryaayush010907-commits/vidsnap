...
// Note: Metadata can't be used in client components, so we'll add it separately via a layout file
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-b from-white via-slate-50 to-slate-100">
      ...
      <main className="relative z-10">
        ...
        {/* Content */}
        <div className="max-w-2xl mx-auto px-4 py-12 lg:px-8 lg:py-20">
          {/* Introduction */}
          <section className="space-y-6 mb-12">
            <div>
              <h2 className="text-3xl font-bold text-slate-900 mb-4">Get in Touch</h2>
              <p className="text-slate-700 text-lg">
                Have a question, suggestion, or concern? We&apos;d love to hear from you. Fill out the form below and we&apos;ll
          ...
          <section className="mt-12 space-y-6">
            <h3 className="text-2xl font-bold text-slate-900">Ways to Reach Us</h3>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="rounded-[1.75rem] border border-slate-200 bg-slate-50 p-6">
                <h4 className="text-lg font-semibold text-slate-900 mb-2">✉️ Email</h4>
                <p className="text-slate-700">For general inquiries: videosnap043@gmail.com</p>
              </div>
              <div className="rounded-[1.75rem] border border-slate-200 bg-slate-50 p-6">
                <h4 className="text-lg font-semibold text-slate-900 mb-2">⏱️ Response Time</h4>
